 ...
 if(isset($_POST['add_product'])){
   ...
   if(empty($errors)){
     ...
     if($db->query($query)){
       ...
       $session->msg('d','Fallo al agregar el gasto, intena nuevamente.');
               ...
               <div class="row">
                 ...
                 <div class="col-md-4">
                   <div class="input-group">
                     ...
                     <input type="number" class="form-control" name="buying-price" placeholder="COSTO PRODUCCIÓN">
                  ...
                  <div class="col-md-4">
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="saleing-price" placeholder="COSTO VENTA">
                      <span class="input-group-addon">.00</span>
                   </div>
                  </div>
               </div>
